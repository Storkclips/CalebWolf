  ...
  const handleRedeem = async (e) => {
    ...
    try {
      ...
      if (error) {
        setRedeemMsg({
          type: 'error',
          text: data?.error || error.message || 'Invalid code',
        });
      } else if (data.success) {
        setRedeemMsg({
          type: 'success',
          text: `Unlocked: ${data.collection}`,
        });
    ...
    return (
      <Layout>
        <div className="lib-empty-state lib-empty-state--page">
          ...
          <Link to="/login" className="btn" style={{ marginTop: 24 }}>
            Sign in
          </Link>
        </div>
      </Layout>
          ...
          {loading ? (
            ...
            <div className="lib-empty-state">
              ...
              >
                ...
                <Link className="ghost" to="/buy-credits">
                  Buy credits
                </Link>
              </div>
            </div>
            ...
            <>
              ...
              <div className="lib-footer-actions">
                ...
                <Link className="pill" to="/buy-credits">
                  Buy credits
                </Link>
              </div>
            </>
        ...
        <div className="lib-body">
          <div className="lib-redeem-wrap">
            <div className="lib-redeem-card">
              ...
              {redeemMsg && <div className={`lib-redeem-msg ${redeemMsg.type}`}>{redeemMsg.text}</div>}
            </div>
          </div>
        </div>
      )}
      ...
      {lightbox && (
        ...
        >
          <div className="library-lightbox-panel">
            <button className="icon-button close" type="button" onClick={() => setLightbox(null)}>
              ✕
            </button>
            ...
            <div className="library-lightbox-details">
              ...
              <div className="library-lightbox-actions">
