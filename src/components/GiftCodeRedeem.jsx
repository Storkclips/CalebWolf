...
const GiftCodeRedeem = () => {
  ...
  return (
    <section
      className="gift-redeem-section"
      style={{ maxWidth: 520, margin: '0 auto', padding: '2rem 0' }}
    >
              ...
              {showInfo && (
                ...
                >
                  ...
                  <p style={{ margin: 0, color: 'var(--muted)' }}>
                    Disable coupon or discount browser extensions like Honey, Capital One
                    Shopping, or RetailMeNot. These may intercept or corrupt your code,
                    causing it to fail or be marked as used.
                  </p>
                </div>
              )}
            </div>
